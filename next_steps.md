...
git branch -M main
git remote add origin git@github.com:mess-nlesc/kunefe
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/mess-nlesc/repositories/new](https://github.com/organizations/mess-nlesc/repositories/new)
and create a new repository named `kunefe` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/mess-nlesc/kunefe/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
