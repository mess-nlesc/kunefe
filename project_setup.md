...
- We recommend writing the documentation using Restructured Text (reST) and Google style docstrings.
  - [Restructured Text (reST) and Sphinx CheatSheet](https://www.sphinx-doc.org/en/master/usage/restructuredtext/index.html)
...
- For convenience, the package version is stored in a single place: `kunefe/pyproject.toml` under the `tool.bumpversion` header.
